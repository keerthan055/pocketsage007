  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const endpoints = [
        ...
        'http://localhost:8000/fds/current',
        'http://localhost:8000/fds/history',
        'http://localhost:8000/dashboard/daily-briefing',
        'http://localhost:8000/dashboard/score-breakdown'
      ];
